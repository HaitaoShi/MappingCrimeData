...
```{r}
residential_count <- read_excel("/Users/shihaitao/Library/Mobile Documents/com~apple~CloudDocs/Documents/M1_Documents/爱丁堡大学培训/MappingCrimeData/MappingCrimeData/Data/census_data/res_count.xlsx") %>% clean_names() %>%
...
```{r}
workday_count <- read_excel("/Users/shihaitao/Library/Mobile Documents/com~apple~CloudDocs/Documents/M1_Documents/爱丁堡大学培训/MappingCrimeData/MappingCrimeData/Data/census_data/work_count.xlsx") %>% clean_names() %>%
  rename(lsoa = e01030757, #rename the variables 
         name = surrey_heath_002a, 
         work_count = x330) 
...
surrey_lsoa <- surrey_lsoa %>% 
  mutate(crime_rate2 = (count/workday_count)*1000)
